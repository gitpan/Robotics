# This Makefile is for the Robotics extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Robotics.pm]
#     AUTHOR => q[Jonathan Cline <jcline@ieee.org>]
#     LICENSE => q[perl]
#     NAME => q[Robotics]
#     PERLRUN => q[/cygdrive/c/perl/bin/perl]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Robotics.pm]
#     clean => { FILES=>q[Robotics-*] }
